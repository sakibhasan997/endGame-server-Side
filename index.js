...
const uri =
  `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.7suhtvy.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const collegeSixCardCollection = client.db("EndGame-Project").collection("collegeSixCard");
    const collegeThreeCardCollection = client.db("EndGame-Project").collection("collegeThreeCard");
